...
/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+actionscript+batch+c+csharp+cpp+css-extras+csv+diff+git+ignore+ini+js-extras+json+kumir+less+makefile+markdown+markup-templating+mongodb+nginx+nsis+pascal+php+php-extras+powershell+python+regex+sass+scss+twig+typescript+visual-basic+xml-doc+yaml&plugins=line-numbers+show-invisibles+autolinker+wpd+custom-class+file-highlight+show-language+jsonp-highlight+highlight-keywords+inline-color+previewers+keep-markup+command-line+unescaped-markup+normalize-whitespace+data-uri-highlight+toolbar+copy-to-clipboard+download-button+match-braces+diff-highlight+filter-highlight-all+treeview */
